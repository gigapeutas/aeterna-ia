...
function resetChat() {
  ...
  autoResize();
  updateSendBtn();
  // Fecha sidebar no mobile ao iniciar novo chat
  closeSidebar();
}
...
function initEventListeners() {
  ...
  // Sidebar toggle (desktop — fecha a sidebar)
  sidebarToggle?.addEventListener('click', toggleSidebar);

  // Sidebar toggle (mobile — hamburger abre a sidebar)
  mobileSidebarToggle?.addEventListener('click', openSidebar);

  // Overlay (fecha sidebar no mobile ao clicar fora)
  sidebarOverlay?.addEventListener('click', closeSidebar);

  // Suggestion cards — preenche e envia automaticamente
